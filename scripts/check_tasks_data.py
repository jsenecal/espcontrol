...
TASKS = (
    ...
    task("firmware-release", ("python3", "scripts/check_firmware_release.py"), profiles=FAST + RELEASE,
         domains=("firmware", "web", "product", "workflow"), inputs=("builds/**", "common/device/esp32_c6_recovery.yaml", "components/c6_recovery/**", "devices/**", "docs/getting-started/**", "docs/screens/**", "docs/public/webserver/**", "product/release_contract.json", ".github/esphome.env", ".github/workflows/firmware-compile.yml", ".github/workflows/nightly-firmware.yml", ".github/workflows/pages.yml", ".github/workflows/release.yml", ".agents/skills/release/SKILL.md", "scripts/firmware_release.py", "scripts/prepare_c6_firmware.py", "scripts/check_firmware_release.py"), cache="never"),
