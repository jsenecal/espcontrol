...
TASKS = (
    ...
    task("product-model-v2", ("python3", "scripts/check_product_model_v2.py", "--self-test"),
         ...
         domains=("product",), inputs=("product/model_v2.json", "product/v2/**", "common/config/**", "common/assets/icons.json", "compatibility/fixtures/product_compatibility.json", "devices/catalog.json", "devices/manifest.json", "scripts/product_model_v2.py", "scripts/check_product_model_v2.py"), parallel_safe=True),
